    ...
    <main className="shell">
      ...
      <section className="container">
        ...
        {approved ? <form className="card" style={{ marginTop: 28 }} onSubmit={createCampaign}>
          ...
          <div className="field"><label htmlFor="firstActionAt">Primeira convocação</label><input id="firstActionAt" name="firstActionAt" type="datetime-local" required /></div>
          <div className="grid"><div className="field"><label htmlFor="secondIntervalDays">Dias até a 2ª</label><input id="secondIntervalDays" name="secondIntervalDays" type="number" min="1" max="30" defaultValue="2" required /></div><div className="field"><label htmlFor="secondStartTime">Horário da 2ª</label><input id="secondStartTime" name="secondStartTime" type="time" defaultValue="09:00" required /></div><div className="field"><label htmlFor="thirdIntervalDays">Dias até a 3ª</label><input id="thirdIntervalDays" name="thirdIntervalDays" type="number" min="1" max="30" defaultValue="3" required /></div><div className="field"><label htmlFor="thirdStartTime">Horário da 3ª</label><input id="thirdStartTime" name="thirdStartTime" type="time" defaultValue="09:00" required /></div></div>
